...
const adminEndpoints = {
  ...
  updateGenre: (id, genreData) => commonAPI.put(`/admin/genres/${id}`, genreData), // PUT {{commonServiceUrl}}/api/common/admin/genres/:id (Admin only)
  deleteGenre: (id) => commonAPI.delete(`/admin/genres/${id}`), // DELETE {{commonServiceUrl}}/api/common/admin/genres/:id (Admin only)
};
