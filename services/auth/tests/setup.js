...
module.exports = {
  setupDatabase: async () => {
    try {
      ...
      console.error('❌ Auth service database setup failed:', error.message);
      throw error;
    }
  },
  ...
  teardownDatabase: async () => {
    try {
      ...
      console.log('✅ Auth service database teardown complete');
    } catch (error) {
      console.error('❌ Auth service database teardown failed:', error.message);
    }
  }
};
