...
module.exports = {
  setupDatabase: async () => {
    try {
      ...
      console.log('✅ Streaming service database setup complete');
      return sequelize;
    } catch (error) {
      console.error('❌ Streaming service database setup failed:', error.message);
      throw error;
    }
  },
  ...
  teardownDatabase: async () => {
    try {
      ...
      console.log('✅ Streaming service database teardown complete');
    } catch (error) {
      console.error('❌ Streaming service database teardown failed:', error.message);
    }
  }
};
