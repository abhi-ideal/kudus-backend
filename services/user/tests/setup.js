...
module.exports = {
  setupDatabase: async () => {
    try {
      ...
      console.log('✅ User service database setup complete');
      return sequelize;
    } catch (error) {
      console.error('❌ User service database setup failed:', error.message);
      throw error;
    }
  },
  ...
  teardownDatabase: async () => {
    try {
      ...
      console.log('✅ User service database teardown complete');
    } catch (error) {
      console.error('❌ User service database teardown failed:', error.message);
    }
  }
};
